...
[下載 Windows x64 執行檔](https://github.com/silver0416/MaiMotionDemo/releases/download/v0.4.5/MaiMotionDemo-v0.4.5-windows-x64.exe) · [所有版本](https://github.com/silver0416/MaiMotionDemo/releases) · [使用手冊](USER_GUIDE.md)
...
- 每次開啟自動檢查更新，可以直接在程式內下載新版並重新啟動，舊版會自動移除
